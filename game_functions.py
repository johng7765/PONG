...
def check_ball_horizontal_edges(ai_settings, stats, sb, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball):
    if ball.check_user_horizontal_edge():
        edge_hit(ai_settings, stats, sb, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball)
    elif ball.check_comp_horizontal_edge():
        level_up(ai_settings, stats, sb, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball)


def check_ball_vertical_top_edge(ai_settings, stats, sb, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball):
...
def check_ball_vertical_bottom_edge(ai_settings, stats, sb, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball):
...
def check_events(ai_settings, screen, stats, sb, play_button, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(ai_settings, stats, sb, play_button, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball, mouse_x, mouse_y)
...
def check_play_button(ai_settings, stats, sb, play_button, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball, mouse_x, mouse_y):
...
def edge_hit(ai_settings, stats, sb, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball):
    if stats.computer_score < 15:
...
def level_up(ai_settings, stats, sb, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball):
    if stats.player_score < 10:
        # Speed up the game
...
def update_ball(ai_settings, stats, sb, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball):
    """Check if the ball is at an edge, and then Update the position of the ball in the fleet."""
    check_ball_horizontal_edges(ai_settings, stats, sb, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball)
    check_ball_vertical_top_edge(ai_settings, stats, sb, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball)
    check_ball_vertical_bottom_edge(ai_settings, stats, sb, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball)
    ball.update()
...
def update_screen(ai_settings, screen, stats, sb, paddle_top, paddle_bottom, paddle_left, comp_paddle_top, comp_paddle_right, comp_paddle_bottom, ball, play_button, net):
    ...
    # Draw the play button if the game is inactve.
